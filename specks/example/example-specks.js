/*
	...
	Any comments, suggestions, help or criticism is extremely welcome. 
...
//Sets various attributes of the speck object to a default value. These can be adjusted, added to etc. 	
...
function styleElements(speck){ //Applies CSS to speck elements, including specified widths and heights
	...
	$(toClass(speck.name)).each(function(index){
		...
		//If different heights/widths have been entered for each image, input those values into the CSS
...
//This is the function which does all the work.
	...
	//Change the background image of current element
...
function swapBackgroundImg(elementName, noOfElements, noOfBackgrounds, i) { //Changes the background image for the next one in the folder.
